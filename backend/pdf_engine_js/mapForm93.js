...
add(textField(1, 96.2, 198.6, 205.6, first, 560, 8, 11.8, -1));
add(textField(1, 102.5, 212.0, 219.0, middle, 560, 8, 11.8, -1));
add(textField(1, 95.8, 225.7, 232.7, last, 560, 8, 11.8, -1));
