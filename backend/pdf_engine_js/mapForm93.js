...
add(textField(1, 91.2, 198.6, 205.6, first, 560, 8, 10.9, 0));
add(textField(1, 97.2, 212.0, 219.0, middle, 560, 8, 10.9, 0));
add(textField(1, 90.8, 225.7, 232.7, last, 560, 8, 10.9, 0));
